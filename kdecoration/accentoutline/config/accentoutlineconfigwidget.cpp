    ...
    : KCModule(parent, data)
{
    ...
    auto *help = new QLabel(i18n("The outline is drawn only on the focused window. Rounded corners apply to every window, focused or not. "
                                 "The outline requests Plasma's wallpaper accent color; if Plasma cannot provide one, "
